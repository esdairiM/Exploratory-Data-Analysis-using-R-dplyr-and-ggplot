...
Now we will see if there is any association between education level and income level, we will use a set of two categrical variables:
...
we can see that there are 6 categroies in education level variable
