...
heart_attack_simulation <-
  as.factor(sample( c("Yes", "No"), 
                    480818, 
                    prob = c(0.0591, 0.9409), 
                    replace = TRUE)) 

sleep_condition_simulation <-
  as.factor(sample( c("normal", "sleep deprived"), 
                    480818, prob = c( 0.6727,  0.3273), 
                    replace = TRUE)) 



heart_attack_by_sleep_simulation <-
  data.frame(
...
head(heart_attack_by_sleep_simulation)
